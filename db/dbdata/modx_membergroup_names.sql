...
REPLACE INTO `modx_membergroup_names` VALUES (1,'Administrator','',0,0,1);
...
REPLACE INTO `modx_membergroup_names` VALUES (4,'Customers','Покупатели интернет-магазина',0,0,1);
REPLACE INTO `modx_membergroup_names` VALUES (5,'Order Managers','Обработчики заказов',0,0,1);
