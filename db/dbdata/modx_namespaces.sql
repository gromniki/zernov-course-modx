...
REPLACE INTO `modx_namespaces` VALUES ('clientconfig','{core_path}components/clientconfig/','{assets_path}components/clientconfig/');
REPLACE INTO `modx_namespaces` VALUES ('minishop2','{core_path}components/minishop2/','');
