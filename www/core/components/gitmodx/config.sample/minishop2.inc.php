...
return [
    ...
    'ms2_category_grid_fields' => 'id,menuindex,pagetitle,article,price,thumb,new,favorite,popular,count,order_price',
    ...
    'ms2_product_extra_fields' => 'price,old_price,article,weight,color,size,vendor,made_in,tags,new,popular,favorite,count,order_price',
